...
setblock ~1 ~0 ~6 birch_wall_sign{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome\"}}",Text2:"{\"text\":\"Lush Caves\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run scoreboard players set load_biome funcs 20\"}}",Text3:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur\"}}",Text4:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome\"}}",}
setblock ~0 ~0 ~6 birch_wall_sign{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome\"}}",Text2:"{\"text\":\"Dripstone Caves\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run scoreboard players set load_biome funcs 21\"}}",Text3:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur\"}}",Text4:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome\"}}",}

setblock ~1 ~1 ~6 birch_wall_sign{Text2:"{\"text\":\"Caves and Cliffs\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=category_action_home] positioned ~0 ~2 ~0 run execute at @e[tag=category_home] run function restworld:biomes/category\"}}",Text3:"\"Biomes\""}
