...
setblock ~-1 ~0 ~6 birch_wall_sign{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome\"}}",Text2:"{\"text\":\"The End\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run scoreboard players set load_biome funcs 27\"}}",Text3:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur\"}}",Text4:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome\"}}",}
setblock ~-2 ~0 ~6 birch_wall_sign{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome\"}}",Text2:"{\"text\":\"End Island\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run scoreboard players set load_biome funcs 28\"}}",Text3:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur\"}}",Text4:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome\"}}",}
setblock ~-3 ~0 ~6 birch_wall_sign{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome\"}}",Text2:"{\"text\":\"End City\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run scoreboard players set load_biome funcs 29\"}}",Text3:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur\"}}",Text4:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome\"}}",}

setblock ~-1 ~1 ~6 birch_wall_sign{Text2:"{\"text\":\"End\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"execute at @e[tag=category_action_home] positioned ~0 ~2 ~0 run execute at @e[tag=category_home] run function restworld:biomes/category\"}}",Text3:"\"Biomes\""}
