...
execute if score redstone_torch funcs matches 0 run setblock ~-1 ~-1 ~-1 redstone_block

execute if score redstone_torch funcs matches 1 run setblock ~-1 ~-1 ~-1 air
