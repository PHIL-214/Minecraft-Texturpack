...
execute if score daylight_detector funcs matches 0 run execute if score daylight_inv funcs matches 1 run fill ~3 ~8 ~3 ~-3 ~8 ~-3 stone
...
execute if score daylight_detector funcs matches 1 run execute if score daylight_inv funcs matches 1 run fill ~2 ~8 ~2 ~-2 ~8 ~-2 stone
...
execute if score daylight_detector funcs matches 2 run execute if score daylight_inv funcs matches 1 run fill ~1 ~8 ~1 ~-1 ~8 ~-1 stone
...
execute if score daylight_detector funcs matches 3 run execute if score daylight_inv funcs matches 1 run fill ~0 ~8 ~0 ~0 ~8 ~0 stone
...
execute if score daylight_detector funcs matches 27 run execute if score daylight_inv funcs matches 1 run fill ~0 ~8 ~0 ~0 ~8 ~0 stone
...
execute if score daylight_detector funcs matches 28 run execute if score daylight_inv funcs matches 1 run fill ~1 ~8 ~1 ~-1 ~8 ~-1 stone
...
execute if score daylight_detector funcs matches 29 run execute if score daylight_inv funcs matches 1 run fill ~2 ~8 ~2 ~-2 ~8 ~-2 stone
