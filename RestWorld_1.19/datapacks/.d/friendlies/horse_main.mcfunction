...
execute if score horse funcs matches 0 at @e[tag=brown_horses,tag=kid] run data merge block ~2 ~0 ~0 {Text3:"\"None\""}
...
execute if score horse funcs matches 1 at @e[tag=brown_horses,tag=kid] run data merge block ~2 ~0 ~0 {Text3:"\"White\""}
...
execute if score horse funcs matches 2 at @e[tag=brown_horses,tag=kid] run data merge block ~2 ~0 ~0 {Text3:"\"White Field\""}
...
execute if score horse funcs matches 3 at @e[tag=brown_horses,tag=kid] run data merge block ~2 ~0 ~0 {Text3:"\"White Dots\""}
...
execute if score horse funcs matches 4 at @e[tag=brown_horses,tag=kid] run data merge block ~2 ~0 ~0 {Text3:"\"Black Dots\""}
