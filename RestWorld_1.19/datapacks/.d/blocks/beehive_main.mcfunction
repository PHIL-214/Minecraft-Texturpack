...
execute if score beehive funcs matches 0 run setblock ~0 ~3 ~0 beehive[facing=south,honey_level=0]
execute if score beehive funcs matches 0 run data merge block ~0 ~2 ~-1 {Text2:"\"Beehive\"",Text3:"\"\"",Text4:"\"\""}


execute if score beehive funcs matches 1 run setblock ~0 ~3 ~0 beehive[facing=south,honey_level=1]
execute if score beehive funcs matches 1 run data merge block ~0 ~2 ~-1 {Text2:"\"Beehive\"",Text3:"\"\"",Text4:"\"\""}


execute if score beehive funcs matches 2 run setblock ~0 ~3 ~0 beehive[facing=south,honey_level=2]
execute if score beehive funcs matches 2 run data merge block ~0 ~2 ~-1 {Text2:"\"Beehive\"",Text3:"\"\"",Text4:"\"\""}


execute if score beehive funcs matches 3 run setblock ~0 ~3 ~0 beehive[facing=south,honey_level=3]
execute if score beehive funcs matches 3 run data merge block ~0 ~2 ~-1 {Text2:"\"Beehive\"",Text3:"\"\"",Text4:"\"\""}


execute if score beehive funcs matches 4 run setblock ~0 ~3 ~0 beehive[facing=south,honey_level=4]
execute if score beehive funcs matches 4 run data merge block ~0 ~2 ~-1 {Text2:"\"Beehive\"",Text3:"\"\"",Text4:"\"\""}


execute if score beehive funcs matches 5 run setblock ~0 ~3 ~0 beehive[facing=south,honey_level=5]
