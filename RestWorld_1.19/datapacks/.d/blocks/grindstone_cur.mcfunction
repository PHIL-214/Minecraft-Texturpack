...
execute if score grindstone funcs matches 0 run setblock ~0 ~3 ~0 grindstone[face=floor]
execute if score grindstone funcs matches 0 run data merge block ~0 ~2 ~-1 {Text4:"\"\"",Text3:"\"Face Floor\"",Text2:"\"Grindstone\""}


execute if score grindstone funcs matches 1 run setblock ~0 ~3 ~0 grindstone[face=wall]
execute if score grindstone funcs matches 1 run data merge block ~0 ~2 ~-1 {Text4:"\"\"",Text3:"\"Face Wall\"",Text2:"\"Grindstone\""}


execute if score grindstone funcs matches 2 run setblock ~0 ~3 ~0 grindstone[face=ceiling]
