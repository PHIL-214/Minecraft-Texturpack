...
execute if score frosted_ice funcs matches 0 run setblock ~0 ~3 ~0 frosted_ice[age=0]
execute if score frosted_ice funcs matches 0 run data merge block ~0 ~2 ~1 {Text2:"\"Frosted Ice\"",Text3:"\"\"",Text4:"\"\""}


execute if score frosted_ice funcs matches 1 run setblock ~0 ~3 ~0 frosted_ice[age=1]
execute if score frosted_ice funcs matches 1 run data merge block ~0 ~2 ~1 {Text2:"\"Frosted Ice\"",Text3:"\"\"",Text4:"\"\""}


execute if score frosted_ice funcs matches 2 run setblock ~0 ~3 ~0 frosted_ice[age=2]
execute if score frosted_ice funcs matches 2 run data merge block ~0 ~2 ~1 {Text2:"\"Frosted Ice\"",Text3:"\"\"",Text4:"\"\""}


execute if score frosted_ice funcs matches 3 run setblock ~0 ~3 ~0 frosted_ice[age=3]
