...
execute if score dirt blocks matches 0 run data merge block ~0 ~2 ~1 {Text2: '"Dirt"', Text3: '""', Text4: '""'}
execute if score dirt blocks matches 1 run setblock ~0 ~3 ~0 coarse_dirt
execute if score dirt blocks matches 1 run data merge block ~0 ~2 ~1 {Text2: '"Coarse Dirt"', Text3: '""', Text4: '""'}
execute if score dirt blocks matches 2 run setblock ~0 ~3 ~0 rooted_dirt
execute if score dirt blocks matches 2 run data merge block ~0 ~2 ~1 {Text2: '"Rooted Dirt"', Text3: '""', Text4: '""'}
execute if score dirt blocks matches 3 run setblock ~0 ~3 ~0 farmland
execute if score dirt blocks matches 3 run data merge block ~0 ~2 ~1 {Text2: '"Farmland"', Text3: '""', Text4: '""'}
