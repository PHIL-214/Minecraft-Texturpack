...
execute if score slabs blocks matches 0 run data merge block ~0 ~2 ~-1 {Text2: '"Smooth Stone"', Text3: '"Slab"', Text4: '""'}
execute if score slabs blocks matches 1 run setblock ~0 ~3 ~0 petrified_oak_slab
execute if score slabs blocks matches 1 run data merge block ~0 ~2 ~-1 {Text2: '"Petrified Oak"', Text3: '"Slab"', Text4: '""'}
