...
execute if score basic materials matches 0 run execute unless entity @e[tag=armor_horse, distance=..10] run summon horse ~4.5 ~2 ~0.5 {CustomName: '"Horse"', CustomNameVisible: false, NoAI: true, PersistenceRequired: true, Rotation: [180f, 0f], Silent: true, Tags: [armor_horse, material_static, materials, horse, adult], Tame: true, Variant: 1}
...
execute if score basic materials matches 2 run execute unless entity @e[tag=armor_horse, distance=..10] run summon horse ~4.5 ~2 ~0.5 {CustomName: '"Horse"', CustomNameVisible: false, NoAI: true, PersistenceRequired: true, Rotation: [180f, 0f], Silent: true, Tags: [armor_horse, material_static, materials, horse, adult], Tame: true, Variant: 1}
...
execute if score basic materials matches 3 run execute unless entity @e[tag=armor_horse, distance=..10] run summon horse ~4.5 ~2 ~0.5 {CustomName: '"Horse"', CustomNameVisible: false, NoAI: true, PersistenceRequired: true, Rotation: [180f, 0f], Silent: true, Tags: [armor_horse, material_static, materials, horse, adult], Tame: true, Variant: 1}
...
execute if score basic materials matches 4 run execute unless entity @e[tag=armor_horse, distance=..10] run summon horse ~4.5 ~2 ~0.5 {CustomName: '"Horse"', CustomNameVisible: false, NoAI: true, PersistenceRequired: true, Rotation: [180f, 0f], Silent: true, Tags: [armor_horse, material_static, materials, horse, adult], Tame: true, Variant: 1}
