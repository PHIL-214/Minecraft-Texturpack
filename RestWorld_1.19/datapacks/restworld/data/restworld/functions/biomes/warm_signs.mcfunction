...
setblock ~5 ~0 ~6 air
setblock ~5 ~0 ~6 oak_wall_sign[facing=north]{Text1: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome"}, "text": ""}', Text2: '{"clickEvent": {"action": "run_command", "value": "/scoreboard players set load_biome biomes 9"}, "text": "Desert"}', Text3: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur"}, "text": ""}', Text4: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome"}, "text": ""}'}
setblock ~4 ~0 ~6 air
setblock ~4 ~0 ~6 oak_wall_sign[facing=north]{Text1: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome"}, "text": ""}', Text2: '{"clickEvent": {"action": "run_command", "value": "/scoreboard players set load_biome biomes 10"}, "text": "Savanna"}', Text3: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur"}, "text": ""}', Text4: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome"}, "text": ""}'}
setblock ~3 ~0 ~6 air
setblock ~3 ~0 ~6 oak_wall_sign[facing=north]{Text1: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome"}, "text": ""}', Text2: '{"clickEvent": {"action": "run_command", "value": "/scoreboard players set load_biome biomes 11"}, "text": "Badlands"}', Text3: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur"}, "text": ""}', Text4: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome"}, "text": ""}'}
setblock ~5 ~1 ~6 air
setblock ~5 ~1 ~6 birch_wall_sign[facing=north]{Text1: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=category_home] run function restworld:biomes/category"}, "text": ""}', Text2: '"Warm"'}
