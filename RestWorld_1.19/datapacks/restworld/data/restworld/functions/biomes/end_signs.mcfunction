...
setblock ~-1 ~0 ~6 air
setblock ~-1 ~0 ~6 oak_wall_sign[facing=north]{Text1: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome"}, "text": ""}', Text2: '{"clickEvent": {"action": "run_command", "value": "/scoreboard players set load_biome biomes 27"}, "text": "The End"}', Text3: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur"}, "text": ""}', Text4: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome"}, "text": ""}'}
setblock ~-2 ~0 ~6 air
setblock ~-2 ~0 ~6 oak_wall_sign[facing=north]{Text1: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome"}, "text": ""}', Text2: '{"clickEvent": {"action": "run_command", "value": "/scoreboard players set load_biome biomes 28"}, "text": "End Island"}', Text3: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur"}, "text": ""}', Text4: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome"}, "text": ""}'}
setblock ~-3 ~0 ~6 air
setblock ~-3 ~0 ~6 oak_wall_sign[facing=north]{Text1: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/clear_biome"}, "text": ""}', Text2: '{"clickEvent": {"action": "run_command", "value": "/scoreboard players set load_biome biomes 29"}, "text": "End City"}', Text3: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/load_biome_cur"}, "text": ""}', Text4: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=biome_loading_action_home] run function restworld:biomes/cleanup_biome"}, "text": ""}'}
setblock ~-1 ~1 ~6 air
setblock ~-1 ~1 ~6 birch_wall_sign[facing=north]{Text1: '{"clickEvent": {"action": "run_command", "value": "/execute at @e[tag=category_home] run function restworld:biomes/category"}, "text": ""}', Text2: '"End"'}
