...
data merge block ~0 ~1 ~0 {mode: LOAD, name: "restworld:air"}
data merge block ~0 ~1 ~32 {mode: LOAD, name: "restworld:air"}
data merge block ~32 ~1 ~0 {mode: LOAD, name: "restworld:air"}
data merge block ~32 ~1 ~32 {mode: LOAD, name: "restworld:air"}
data merge block ~0 ~1 ~0 {mode: LOAD, name: "restworld:air"}
data merge block ~0 ~1 ~32 {mode: LOAD, name: "restworld:air"}
data merge block ~32 ~1 ~0 {mode: LOAD, name: "restworld:air"}
data merge block ~32 ~1 ~32 {mode: LOAD, name: "restworld:air"}
