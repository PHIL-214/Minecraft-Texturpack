# Generated by root @ 2022-07-01 17:26:12.694266
...
execute if score purpur blocks matches 0 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Purpur Block"', Text3: '""', Text4: '""'}
execute if score purpur blocks matches 1 run setblock ~0 ~3 ~0 purpur_pillar
execute if score purpur blocks matches 1 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Purpur Pillar"', Text3: '""', Text4: '""'}
