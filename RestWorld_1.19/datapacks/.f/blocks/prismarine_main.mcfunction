# Generated by root @ 2022-07-01 17:26:12.690726
...
execute if score prismarine blocks matches 0 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Prismarine"', Text3: '""', Text4: '""'}
execute if score prismarine blocks matches 1 run setblock ~0 ~3 ~0 prismarine_bricks
execute if score prismarine blocks matches 1 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Prismarine Bricks"', Text3: '""', Text4: '""'}
execute if score prismarine blocks matches 2 run setblock ~0 ~3 ~0 dark_prismarine
execute if score prismarine blocks matches 2 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Dark Prismarine"', Text3: '""', Text4: '""'}
