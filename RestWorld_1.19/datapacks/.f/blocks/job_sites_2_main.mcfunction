# Generated by root @ 2022-07-01 17:26:12.727602
...
execute if score job_sites_2 blocks matches 0 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Blast Furnace"', Text3: '""', Text4: '""'}
execute if score job_sites_2 blocks matches 1 run setblock ~0 ~3 ~0 blast_furnace[lit=true]
execute if score job_sites_2 blocks matches 1 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Blast Furnace"', Text3: '""', Text4: '""'}
execute if score job_sites_2 blocks matches 2 run setblock ~0 ~3 ~0 smoker[lit=false]
execute if score job_sites_2 blocks matches 2 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Smoker"', Text3: '""', Text4: '""'}
execute if score job_sites_2 blocks matches 3 run setblock ~0 ~3 ~0 smoker[lit=true]
execute if score job_sites_2 blocks matches 3 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Smoker"', Text3: '""', Text4: '""'}
execute if score job_sites_2 blocks matches 4 run setblock ~0 ~3 ~0 barrel[facing=north, open=true]
execute if score job_sites_2 blocks matches 4 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Barrel"', Text3: '""', Text4: '""'}
execute if score job_sites_2 blocks matches 5 run setblock ~0 ~3 ~0 barrel[facing=north, open=false]
execute if score job_sites_2 blocks matches 5 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Barrel"', Text3: '""', Text4: '""'}
execute if score job_sites_2 blocks matches 6 run setblock ~0 ~3 ~0 lectern[has_book=false]
execute if score job_sites_2 blocks matches 6 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Lectern"', Text3: '""', Text4: '""'}
execute if score job_sites_2 blocks matches 7 run setblock ~0 ~3 ~0 lectern[has_book=true]
execute if score job_sites_2 blocks matches 7 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Lectern"', Text3: '""', Text4: '""'}
