# Generated by root @ 2022-07-01 17:26:12.687409
...
execute if score netherrack blocks matches 0 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Netherrack"', Text3: '""', Text4: '""'}
execute if score netherrack blocks matches 1 run setblock ~0 ~3 ~0 warped_nylium
execute if score netherrack blocks matches 1 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Warped Nylium"', Text3: '""', Text4: '""'}
execute if score netherrack blocks matches 2 run setblock ~0 ~3 ~0 crimson_nylium
execute if score netherrack blocks matches 2 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Crimson Nylium"', Text3: '""', Text4: '""'}
