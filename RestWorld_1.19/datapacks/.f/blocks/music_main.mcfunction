# Generated by root @ 2022-07-01 17:26:12.685534
...
execute if score music blocks matches 0 run data merge block ~0 ~2 ~1 {Text1: '""', Text2: '"Note Block"', Text3: '""', Text4: '""'}
execute if score music blocks matches 1 run setblock ~0 ~3 ~0 jukebox
execute if score music blocks matches 1 run data merge block ~0 ~2 ~1 {Text1: '""', Text2: '"Jukebox"', Text3: '""', Text4: '""'}
execute if score music blocks matches 2 run setblock ~0 ~3 ~0 jukebox[has_record=true]
execute if score music blocks matches 2 run data merge block ~0 ~2 ~1 {Text1: '""', Text2: '"Jukebox Playing"', Text3: '""', Text4: '""'}
