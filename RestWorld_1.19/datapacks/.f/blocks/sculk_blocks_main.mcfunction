# Generated by root @ 2022-07-01 17:26:12.748810
...
execute if score sculk_blocks blocks matches 0 run setblock ~0 ~3 ~0 sculk_vein[north=true]
execute if score sculk_blocks blocks matches 0 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Sculk Vein"', Text3: '""', Text4: '""'}
execute if score sculk_blocks blocks matches 1 run setblock ~0 ~3 ~0 sculk
execute if score sculk_blocks blocks matches 1 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Sculk"', Text3: '""', Text4: '""'}
execute if score sculk_blocks blocks matches 2 run setblock ~0 ~3 ~0 sculk_sensor
execute if score sculk_blocks blocks matches 2 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Sculk Sensor"', Text3: '""', Text4: '""'}
execute if score sculk_blocks blocks matches 3 run setblock ~0 ~3 ~0 sculk_catalyst
execute if score sculk_blocks blocks matches 3 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Sculk Catalyst"', Text3: '""', Text4: '""'}
execute if score sculk_blocks blocks matches 4 run setblock ~0 ~3 ~0 sculk_catalyst[bloom=true]
execute if score sculk_blocks blocks matches 4 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Sculk Catalyst"', Text3: '"Blooming"', Text4: '""'}
execute if score sculk_blocks blocks matches 5 run setblock ~0 ~3 ~0 sculk_shrieker[can_summon=true, shrieking=false]
execute if score sculk_blocks blocks matches 5 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Sculk Shrieker"', Text3: '"Can Summon"', Text4: '""'}
execute if score sculk_blocks blocks matches 6 run setblock ~0 ~3 ~0 sculk_shrieker[can_summon=true, shrieking=true]
execute if score sculk_blocks blocks matches 6 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Sculk Shrieker"', Text3: '"Can Summon"', Text4: '"Shrieking"'}
execute if score sculk_blocks blocks matches 7 run setblock ~0 ~3 ~0 sculk_shrieker[can_summon=false, shrieking=false]
execute if score sculk_blocks blocks matches 7 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Sculk Shrieker"', Text3: '"Can\'t Summon"', Text4: '""'}
execute if score sculk_blocks blocks matches 8 run setblock ~0 ~3 ~0 sculk_shrieker[can_summon=false, shrieking=true]
execute if score sculk_blocks blocks matches 8 run data merge block ~0 ~2 ~-1 {Text1: '""', Text2: '"Sculk Shrieker"', Text3: '"Can\'t Summon"', Text4: '"Shrieking"'}
