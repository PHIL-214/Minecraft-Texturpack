# Generated by root @ 2022-07-01 17:26:12.710045
...
execute if score sticky blocks matches 0 run data merge block ~0 ~2 ~1 {Text1: '""', Text2: '"Slime Block"', Text3: '""', Text4: '""'}
execute if score sticky blocks matches 1 run setblock ~0 ~3 ~0 honey_block
execute if score sticky blocks matches 1 run data merge block ~0 ~2 ~1 {Text1: '""', Text2: '"Honey block"', Text3: '""', Text4: '""'}
