# Generated by root @ 2022-07-01 17:26:12.763440
tag @e[tag=colorings_base_home] remove colorings_home
clone ~1 ~4 ~6 ~-13 ~1 ~-1 ~1 0 ~6
...
execute if score lit_candles blocks matches 0 run fill ~1 ~4 ~6 ~-13 ~2 ~-1 candle[lit=true, candles=1] replace #restworld:candle[candles=1]
execute unless score lit_candles blocks matches 0 run fill ~1 ~4 ~6 ~-13 ~2 ~-1 candle[lit=false, candles=1] replace #restworld:candle[candles=1]
...
execute unless score lit_candles blocks matches 0 run fill ~1 ~4 ~6 ~-13 ~2 ~-1 candle[lit=false, candles=2] replace #restworld:candle[candles=2]
...
execute unless score lit_candles blocks matches 0 run fill ~1 ~4 ~6 ~-13 ~2 ~-1 candle[lit=false, candles=3] replace #restworld:candle[candles=3]
...
execute unless score lit_candles blocks matches 0 run fill ~1 ~4 ~6 ~-13 ~2 ~-1 candle[lit=false, candles=4] replace #restworld:candle[candles=4]
execute if score lit_candles blocks matches 0 run fill ~1 ~4 ~6 ~-13 ~2 ~-1 candle_cake[lit=true] replace #restworld:candle_cake
execute unless score lit_candles blocks matches 0 run fill ~1 ~4 ~6 ~-13 ~2 ~-1 candle_cake[lit=false] replace #restworld:candle_cake
...
data merge entity @e[tag=colorings_armor_stand, limit=1] {ArmorItems: [{Count: 1, id: "minecraft:leather_boots"}, {Count: 1, id: "minecraft:leather_leggins"}, {Count: 1, id: "minecraft:leather_chestplate"}, {Count: 1, id: "minecraft:leather_helmet"}]}
