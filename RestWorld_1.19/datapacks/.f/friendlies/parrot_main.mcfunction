# Generated by root @ 2022-07-01 17:26:12.950373
...
execute if score parrot friendlies matches 0 run execute unless block ~0 ~1 ~0 air run setblock ~0 ~2 ~1 oak_fence_gate
...
execute if score parrot friendlies matches 2 run execute unless block ~0 ~1 ~0 air run setblock ~0 ~2 ~1 oak_fence_gate
...
execute if score parrot friendlies matches 4 run execute unless block ~0 ~1 ~0 air run setblock ~0 ~2 ~1 oak_fence_gate
...
execute if score parrot friendlies matches 6 run execute unless block ~0 ~1 ~0 air run setblock ~0 ~2 ~1 oak_fence_gate
...
execute if score parrot friendlies matches 8 run execute unless block ~0 ~1 ~0 air run setblock ~0 ~2 ~1 oak_fence_gate
