# Generated by root @ 2022-07-01 17:26:12.805660
...
execute positioned ~-3 ~2 ~-100 run kill @e[type=item_frame, tag=label, sort=nearest, distance=..2, limit=1]
summon item_frame ~-3 ~2 ~-100 {Facing: 1, Fixed: true, Invisible: true, Item: {Count: 1, id: stone_button, tag: {display: {Name: '{"text": "Color"}'}}}, Tags: [label]}
setblock ~-2 ~2 ~-1 air
...
execute positioned ~-3 ~2 ~100 run kill @e[type=item_frame, tag=label, sort=nearest, distance=..2, limit=1]
summon item_frame ~-3 ~2 ~100 {Facing: 1, Fixed: true, Invisible: true, Item: {Count: 1, id: stone_button, tag: {display: {Name: '{"text": "Style"}'}}}, Tags: [label]}
setblock ~-2 ~2 ~1 air
