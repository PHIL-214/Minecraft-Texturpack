# Generated by root @ 2022-07-01 17:26:12.809081
...
execute if score bossbar_style containers matches 0 run data merge block ~0 ~2 ~0 {Text3: '"progress"'}
execute if score bossbar_style containers matches 1 run bossbar set restworld:bossbar style notched_6
execute if score bossbar_style containers matches 1 run data merge block ~0 ~2 ~0 {Text3: '"notched_6"'}
execute if score bossbar_style containers matches 2 run bossbar set restworld:bossbar style notched_10
execute if score bossbar_style containers matches 2 run data merge block ~0 ~2 ~0 {Text3: '"notched_10"'}
execute if score bossbar_style containers matches 3 run bossbar set restworld:bossbar style notched_12
execute if score bossbar_style containers matches 3 run data merge block ~0 ~2 ~0 {Text3: '"notched_12"'}
execute if score bossbar_style containers matches 4 run bossbar set restworld:bossbar style notched_20
execute if score bossbar_style containers matches 4 run data merge block ~0 ~2 ~0 {Text3: '"notched_20"'}
