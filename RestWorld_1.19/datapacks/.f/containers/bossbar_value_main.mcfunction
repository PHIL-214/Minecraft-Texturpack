# Generated by root @ 2022-07-01 17:26:12.810620
...
execute if score bossbar_value containers matches 0 run data merge block ~0 ~2 ~0 {Text3: 0}
execute if score bossbar_value containers matches 1 run bossbar set restworld:bossbar value 25
execute if score bossbar_value containers matches 1 run data merge block ~0 ~2 ~0 {Text3: 25}
execute if score bossbar_value containers matches 2 run bossbar set restworld:bossbar value 50
execute if score bossbar_value containers matches 2 run data merge block ~0 ~2 ~0 {Text3: 50}
execute if score bossbar_value containers matches 3 run bossbar set restworld:bossbar value 75
execute if score bossbar_value containers matches 3 run data merge block ~0 ~2 ~0 {Text3: 75}
execute if score bossbar_value containers matches 4 run bossbar set restworld:bossbar value 100
execute if score bossbar_value containers matches 4 run data merge block ~0 ~2 ~0 {Text3: 100}
