# Generated by root @ 2022-07-01 17:26:12.819962
summon armor_stand ~0 ~2 ~-1 {CustomName: '"Armor Stand"', NoAI: true, PersistenceRequired: true, Rotation: [270.0f, 0.0f], ShowArms: true, Silent: true, Tags: [item_holder, item_hands, containers, h, o, l, d, e, r, _, s, t, a, n, d, armor_stand, adult]}
