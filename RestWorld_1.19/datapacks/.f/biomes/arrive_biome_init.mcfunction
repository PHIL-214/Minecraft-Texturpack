# Generated by root @ 2022-07-01 17:26:12.644328
execute positioned ~0 ~3 ~-6 run kill @e[type=item_frame, tag=label, sort=nearest, distance=..2, limit=1]
...
execute positioned ~-1 ~3 ~-6 run kill @e[type=item_frame, tag=label, sort=nearest, distance=..2, limit=1]
...
execute positioned ~0 ~3 ~-2 run kill @e[type=item_frame, tag=label, sort=nearest, distance=..2, limit=1]
...
execute positioned ~-1 ~3 ~-2 run kill @e[type=item_frame, tag=label, sort=nearest, distance=..2, limit=1]
