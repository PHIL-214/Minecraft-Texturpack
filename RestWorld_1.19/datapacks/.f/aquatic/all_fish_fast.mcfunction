# Generated by root @ 2022-07-01 17:26:12.605574
...
scoreboard players operation variant fish = body fish
scoreboard players operation variant fish *= BODY_SCALE fish
scoreboard players operation variant fish += pattern_variant fish
